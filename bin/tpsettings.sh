...
if [ -d "$TPDEV" ]; then
    ...
    #echo -n 80 | sudo tee $TPDEV/speed # def 97 on t450s
    echo -n 7   | sudo tee $TPDEV/drift_time # def 5 on t450s
    echo -n 230 | sudo tee $TPDEV/sensitivity # def 200 on t450s
    #echo -n 200 | sudo tee $TPDEV/rate # def 100 on t450s
